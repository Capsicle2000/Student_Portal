              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Divider(),
                    Text(
                        'Reminder: Quiz on May27th covering topics we covered in last week . Good luck!',
                        style: GoogleFonts.poppins(fontSize: 15)),
                    Divider(),
                    Text(
                        'Reminder: Assignment due May30th. Submit before deadline. Good luck!',
                        style: GoogleFonts.poppins(fontSize: 15)),
                    Divider(),
                    TextButton(
